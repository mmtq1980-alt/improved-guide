...
enum class FamilyRole(val labelAr: String, val labelEn: String) {
    FATHER("الأب", "Father"),
    MOTHER("الأم", "Mother"),
    SON("الابن", "Son"),
...
enum class PlaceType(val labelAr: String, val labelEn: String, val iconName: String) {
    HOME("المنزل", "Home", "home"),
    SCHOOL("المدرسة", "School", "school"),
    UNIVERSITY("الجامعة", "University", "university"),
    WORK("العمل", "Work", "work"),
    CLUB("النادي", "Club", "fitness"),
    HOSPITAL("المستشفى", "Hospital", "hospital"),
    CUSTOM("مكان مخصص", "Custom Place", "place")
}
